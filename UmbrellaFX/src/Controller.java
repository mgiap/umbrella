...
private void selectPattern(ImageView selectedImageView, int slot, int oldSlot) {
    ...
    public void endGame() {
        ...
        // Optionally, you can directly switch to the EndScreen here if needed
        // switchToEndScreen(score);
    }
    ...
    private void onViewScoresButtonClicked() {
        try {
            ...
            // Get the EndScreenController and set the score
            EndScreenController endController = loader.getController();
            endController.setStageAndMainScene(primaryStage, primaryStage.getScene());
